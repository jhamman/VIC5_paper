...
\section{VIC Infrastructure}
  ...
  \subsection{Drivers}
    ...
    \begin{enumerate}
      ...
      \item The \textit{Image Driver} includes a stand-alone space-before-time configuration, NetCDF I/O \citep{Rew_1990}, and uses MPI and OpenMP for parallel processing \citep{Gropp_1996,Dagum_1998}. The parallel processing functionality combined with NetCDF I/O is expected to greatly streamline large spatial simulations. This configuration also facilitates the direct coupling within VIC of streamflow routing, reservoir, and irrigation processes, all of which require spatial knowledge of hydrologic conditions.
