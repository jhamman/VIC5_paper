...
\titlerunninghead{VIC 5.0 - IMPROVEMENTS AND NEW APPLICATIONS}
...
Ongoing applications of the VIC model include the University of Washington's drought monitor and forecast systems, and NASA's land data assimilation systems.
The development of VIC version 5.0 focused on reconfiguring the legacy VIC source code to support a wider range of modern modeling applications.
The VIC source code has been moved to a public Github repository to encourage participation by the model development community-at-large.
...
VIC 5.0 includes four drivers that use the same physical model core: classic, image, CESM, and Python.
...
Finally, we have added a Python driver that provides access to the functions and datatypes of VIC's physical core from a Python interface.
This presentation demonstrates how reconfiguring legacy source code extends the life and applicability of a research model.
\end{abstract}
...
\subsection{Driver Separation}
 - Classic Driver
 - Image Driver
 - Python Driver
 - Misc. Drivers (CESM, LIS)
...
\subsection{Interactive Python Driver}

\section{Discussion and Conclusions}

- Open source / community support
- This configuration facilitates the direct coupling of streamflow routing, reservoir, and irrigation processes within VIC.
- Documentation (http://vic.readthedocs.org) and Source Code Service (https://github.com/UW-Hydro/VIC)
...
This research was supported, in part, under United States Department of Energy (DOE) grants DE-FG02-07ER64460 and DE-SC0006856 to the University of Washington
\end{acknowledgments}
